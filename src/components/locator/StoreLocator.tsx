          ...
          <div className={`col-span-1 ${compact ? "lg:col-span-12" : "lg:col-span-5"}`}>
            <div className="card rounded-2xl border border-[#E8E2DC] bg-white/80 shadow-md p-4 sm:p-6">
              ...
              <div className="flex gap-2 mb-4">
                ...
                {compact && <Link href="/outlets" className="btn btn-outline">Open full map</Link>}
              </div>
                      ...
                      <li key={l.id} className="p-3 rounded-lg border border-[#E8E2DC] bg-white/80">
                        ...
                        {l.vendor && (
                          <div className="text-sm">
                            <span className="font-medium">Vendor:</span> {l.vendor}
                          </div>
                        )}
                        {l.agent && (
                          <div className="text-sm">
                            <span className="font-medium">Agent:</span> {l.agent}
                          </div>
                        )}
                        <div className="flex flex-wrap gap-2 mt-2">
                          {l.phone && (
                            <a className="btn btn-outline" href={`tel:${l.phone}`}>
                              Call
                            </a>
                          )}
                          {l.website && (
                            <a className="btn btn-outline" href={l.website} target="_blank" rel="noopener noreferrer">
                              Website
                            </a>
                          )}
                          {compact ? (
                            ...
                            <button
                              className="btn btn-primary"
                              onClick={() => {
                                setCenter([l.coordinates.lat, l.coordinates.lng]);
                                setHighlightId(l.id);
                              }}
                            >
                              View on map
