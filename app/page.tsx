...
const TopSixFlip = dynamic(() => import("@/components/TopSixFlip"), {
  ssr: false,
});
      ...
      <section className="relative min-h-[var(--hero-min-h-desktop)] md:min-h-[var(--hero-min-h-tablet)] sm:min-h-[var(--hero-min-h-mobile)] flex items-center justify-center overflow-hidden bg-[var(--bb-mahogany)]">
        ...
        <div className="relative z-20 w-full px-6 max-w-7xl mx-auto">
          <div className="min-h-[var(--hero-min-h-desktop)] md:min-h-[var(--hero-min-h-tablet)] sm:min-h-[var(--hero-min-h-mobile)] flex flex-col items-center justify-center text-center py-24">
            ...
            <p className="text-subhero text-white/90 mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                style={{ backgroundColor: "#BB4500", borderColor: "#BB4500" }}
              >
                SHOP COLLECTION
              </a>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-8 fade-in-up">
              <div className="inline-flex items-center gap-3 px-6 py-3 glass-luxury rounded-full">
                ...
                <span className="text-[#BB4500] text-sm font-bold uppercase tracking-[0.2em]">
                  Experience Wellness
                </span>
              </div>
              ...
              >
                Your Journey to{" "}
                <span className="text-luxury">Better Being</span>
              </h2>
            ...
            <div
              className="flex items-center justify-center lg:justify-end fade-in-up"
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 lg:p-12 shadow-lg border border-[#BB4500]/10 hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
                <div className="text-center space-y-6">
                  <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-[#BB4500]/10 to-[#B5A642]/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    <svg
                      className="w-10 h-10 text-[#BB4500]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <h3
                    className="text-2xl font-light text-[#2C2B29]"
                    style={{ fontFamily: "Playfair Display, serif" }}
                  >
                    Discover Our Collection
                  </h3>
                  <p className="text-[#7A7771] leading-relaxed max-w-xs mx-auto">
                    Explore premium wellness products designed to support your
      ...
      <section className="space-luxury relative overflow-hidden bg-[#B5A642]">
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="space-y-12 fade-in-up">
            <h2
              className="text-5xl lg:text-6xl font-light text-[#2C2B29] leading-tight"
              style={{ fontFamily: "Playfair Display, serif" }}
            >
              Become a Better Being{" "}
              <span className="not-italic text-[#BB4500]">Stockist</span>
            </h2>
            ...
            <p className="text-xl leading-relaxed text-[#2C2B29]/90 max-w-3xl mx-auto font-light">
              Stock a wellness range your shoppers trust. Clear margins, simple
              MOQs, fast reorders, and launch/training support — so that
              products fly off of your shelves and your team feels confident.
            </p>
            <div className="pt-8">
              <a
                href="/portal-access"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="space-y-8 fade-in-up">
            <div className="inline-flex items-center gap-3 px-6 py-3 glass-luxury rounded-full">
              ...
              <span className="text-[#8B4513] text-sm font-bold uppercase tracking-[0.2em]">
                Join Our Community
              </span>
            </div>

            <h2
              className="text-4xl lg:text-5xl font-light text-[#8B4513] leading-tight"
              style={{ fontFamily: "Playfair Display, serif" }}
            >
              Stay Connected to Your{" "}
              <span className="text-luxury">Wellness Journey</span>
            </h2>

            <p className="text-lg text-[#7A7771] max-w-2xl mx-auto leading-relaxed">
              Get exclusive access to wellness tips, new product launches, and
              special offers. Join thousands who trust us for their daily
              wellness rituals.
            </p>
            ...
            <div className="mt-12">
              <div className="max-w-md mx-auto">
                ...
                <p className="mt-3 text-xs text-[#7A7771]">
