          ...
          >
            <Popup>
              <div style={{ minWidth: 200 }}>
                ...
                <div style={{ fontSize: 12, opacity: 0.8, marginBottom: 6 }}>{m.type === "distributor" ? "Distribution Point" : "Retail Store"}</div>
                ...
                {m.phone && (
                  <div style={{ marginTop: 6 }}>
                    <a href={`tel:${m.phone}`} style={{ color: "#BB4500" }}>{m.phone}</a>
                  </div>
                )}
                {m.website && (
                  <div>
                    <a href={m.website} target="_blank" rel="noopener noreferrer" style={{ color: "#BB4500" }}>Website</a>
                  </div>
                )}
              </div>
            </Popup>
