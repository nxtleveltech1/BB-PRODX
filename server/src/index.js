...
// Graceful error handling for common startup issues (e.g., EADDRINUSE)
server.on('error', (err) => {
  if (err && err.code === 'EADDRINUSE') {
    ...
    console.error('\nAlternatively, set a different PORT in server/.env and align NEXT_PUBLIC_API_URL in .env.local.');
    process.exit(1);
  }
